...
torch_made = MADE(input_shape,vocab_size, hidden_dims=[20, 20])
print(torch_made)

inp = torch.ones(input_shape)
res = torch_made(inp)
print( 'res shape', res.shape )
print('inputs::::', inp[0,0,:], inp[0,1,:])
print('outputs::::', res[0,0,:], res[0,1,:])

inp_tf = tf.ones(input_shape)
res_tf = tf_made( inp_tf )
print( 'res shape', res_tf.shape )
print('inputs::::', inp_tf[0,0,:], inp_tf[0,1,:])
print('outputs::::', res_tf[0,0,:], res_tf[0,1,:])
